پروژه request management یک برنامه برای مدیریت درخواست‌ها به زبان c++ می‌باشد در آن از الگوریتم‌های موجود در کتاب introduction to algorithms(CLRS) الگو گرفته شده است. عملکرد آن به شرح زیر است:
